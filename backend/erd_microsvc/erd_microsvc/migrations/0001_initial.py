# Generated by Django 3.2 on 2022-11-30 19:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_no', models.BigIntegerField(max_length=100)),
                ('unique_hash', models.CharField(max_length=100)),
                ('engine_name', models.CharField(max_length=100)),
                ('is_active', models.BooleanField(default=True)),
                ('create_ts', models.DateTimeField(auto_now_add=True)),
                ('address', jsonfield.fields.JSONField(default=dict)),
                ('schema_key', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='erd_microsvc.category_schema', verbose_name='Category')),
            ],
        ),
    ]
